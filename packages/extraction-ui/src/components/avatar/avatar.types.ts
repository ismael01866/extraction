...
export type AvatarProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<ComponentProps<typeof Avatar.Root>, 'as' | 'asChild' | 'className' | 'children'>
>;

export type AvatarImageProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<ComponentProps<typeof Avatar.Image>, 'as' | 'asChild' | 'className' | 'children'>
>;

export type AvatarFallbackProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
