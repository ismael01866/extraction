...
export type SliderProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<ComponentProps<typeof Slider.Root>, 'as' | 'asChild' | 'className' | 'children'>
>;

export type SliderTrackProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<ComponentProps<typeof Slider.Track>, 'as' | 'asChild' | 'className' | 'children'>
>;

export type SliderRangeProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<ComponentProps<typeof Slider.Range>, 'as' | 'asChild' | 'className' | 'children'>
>;

export type SliderThumbProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
