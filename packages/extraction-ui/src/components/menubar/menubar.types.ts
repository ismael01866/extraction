...
export type MenubarProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<ComponentProps<typeof Menubar.Root>, 'as' | 'asChild' | 'className' | 'children'>
>;

export type MenubarTriggerProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<ComponentProps<typeof Menubar.Trigger>, 'as' | 'asChild' | 'className' | 'children'>
>;

export type MenubarContentProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
...
export type MenubarItemProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<ComponentProps<typeof Menubar.Item>, 'as' | 'asChild' | 'className' | 'children'>
>;

export type MenubarIndicatorProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<ComponentProps<typeof Menubar.ItemIndicator>, 'as' | 'asChild' | 'className' | 'children'>
>;

export type MenubarLabelProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
...
export type MenubarSeparatorProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<ComponentProps<typeof Menubar.Separator>, 'as' | 'asChild' | 'className' | 'children'>
>;

export type MenubarRadioGroupProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<ComponentProps<typeof Menubar.RadioGroup>, 'as' | 'asChild' | 'className' | 'children'>
>;

export type MenubarRadioItemProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<ComponentProps<typeof Menubar.RadioItem>, 'as' | 'asChild' | 'className' | 'children'>
>;

export type MenubarCheckboxItemProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<ComponentProps<typeof Menubar.CheckboxItem>, 'as' | 'asChild' | 'className' | 'children'>
>;

export type MenubarSubProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<ComponentProps<typeof Menubar.Sub>, 'as' | 'asChild' | 'className' | 'children'>
>;

export type MenubarSubTriggerProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<ComponentProps<typeof Menubar.SubTrigger>, 'as' | 'asChild' | 'className' | 'children'>
>;

export type MenubarSubContentProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
