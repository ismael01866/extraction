...
export type ScrollAreaProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
...
export type ScrollAreaThumbProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<ComponentProps<typeof ScrollArea.Thumb>, 'as' | 'asChild' | 'className' | 'children'>
>;

export type ScrollAreaCornerProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
