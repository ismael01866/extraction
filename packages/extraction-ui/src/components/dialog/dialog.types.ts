...
export type DialogTriggerProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
...
export type DialogOverlayProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<ComponentProps<typeof Dialog.Overlay>, 'as' | 'asChild' | 'className' | 'children'>
>;

export type DialogContentProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
...
export type DialogTitleProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<ComponentProps<typeof Dialog.Title>, 'as' | 'asChild' | 'className' | 'children'>
>;

export type DialogDescriptionProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<ComponentProps<typeof Dialog.Description>, 'as' | 'asChild' | 'className' | 'children'>
>;

export type DialogCloseProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
