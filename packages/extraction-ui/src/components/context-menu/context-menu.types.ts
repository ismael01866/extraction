...
export type ContextMenuTriggerProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<ComponentProps<typeof ContextMenu.Trigger>, 'as' | 'asChild' | 'className' | 'children'>
>;

export type ContextMenuContentProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
...
export type ContextMenuItemProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<ComponentProps<typeof ContextMenu.Item>, 'as' | 'asChild' | 'className' | 'children'>
>;

export type ContextMenuIndicatorProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<
...
export type ContextMenuLabelProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
...
export type ContextMenuSeparatorProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<ComponentProps<typeof ContextMenu.Separator>, 'as' | 'asChild' | 'className' | 'children'>
>;

export type ContextMenuRadioGroupProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<ComponentProps<typeof ContextMenu.RadioGroup>, 'as' | 'asChild' | 'className' | 'children'>
>;

export type ContextMenuRadioItemProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<ComponentProps<typeof ContextMenu.RadioItem>, 'as' | 'asChild' | 'className' | 'children'>
>;

export type ContextMenuCheckboxItemProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<ComponentProps<typeof ContextMenu.CheckboxItem>, 'as' | 'asChild' | 'className' | 'children'>
>;

export type ContextMenuSubProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<ComponentProps<typeof ContextMenu.Sub>, 'as' | 'asChild' | 'className' | 'children'>
>;

export type ContextMenuSubTriggerProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<ComponentProps<typeof ContextMenu.SubTrigger>, 'as' | 'asChild' | 'className' | 'children'>
>;

export type ContextMenuSubContentProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
