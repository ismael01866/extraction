...
export type DropdownMenuTriggerProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<ComponentProps<typeof DropdownMenu.Trigger>, 'as' | 'asChild' | 'className' | 'children'>
>;

export type DropdownMenuContentProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
...
export type DropdownMenuItemProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<ComponentProps<typeof DropdownMenu.Item>, 'as' | 'asChild' | 'className' | 'children'>
>;

export type DropdownMenuIndicatorProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<
...
export type DropdownMenuLabelProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
...
export type DropdownMenuSeparatorProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<ComponentProps<typeof DropdownMenu.Separator>, 'as' | 'asChild' | 'className' | 'children'>
>;

export type DropdownMenuRadioGroupProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<ComponentProps<typeof DropdownMenu.RadioGroup>, 'as' | 'asChild' | 'className' | 'children'>
>;

export type DropdownMenuRadioItemProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<ComponentProps<typeof DropdownMenu.RadioItem>, 'as' | 'asChild' | 'className' | 'children'>
>;

export type DropdownMenuCheckboxItemProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<
...
export type DropdownMenuSubProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<ComponentProps<typeof DropdownMenu.Sub>, 'as' | 'asChild' | 'className' | 'children'>
>;

export type DropdownMenuSubTriggerProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<ComponentProps<typeof DropdownMenu.SubTrigger>, 'as' | 'asChild' | 'className' | 'children'>
>;

export type DropdownMenuSubContentProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
