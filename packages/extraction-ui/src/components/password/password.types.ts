...
export type PasswordInputProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<ComponentProps<typeof Password.Input>, 'as' | 'asChild' | 'className' | 'children'>
>;

export type PasswordToggleProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<ComponentProps<typeof Password.Toggle>, 'as' | 'asChild' | 'className' | 'children'>
>;

export type PasswordIconProps<T extends ElementType> = MergeElementProps<
  ElementProps<T>,
  Omit<
