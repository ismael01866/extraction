...
:root {
  ...
  --ex-blockquote-gap-y-md: calc(var(--spacing) * 2.5);
  --ex-blockquote-gap-y-lg: calc(var(--spacing) * 3);
  ...
  --ex-blockquote-cite-font-weight-sm: var(--font-weight-normal);
  --ex-blockquote-cite-font-weight-md: var(--font-weight-normal);
  --ex-blockquote-cite-font-weight-lg: var(--font-weight-normal);
