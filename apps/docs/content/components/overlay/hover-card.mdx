...
:root {
  ...
  --ex-hover-card-max-width-sm: var(--container-3xs);
  --ex-hover-card-max-width-md: var(--container-2xs);
  ...
  --ex-hover-card-section-gap-y-md: calc(var(--spacing) * 2.5);
  --ex-hover-card-section-gap-y-lg: calc(var(--spacing) * 3);
  ...
  --ex-hover-card-title-line-height-sm: var(--text-sm--line-height);
  --ex-hover-card-title-line-height-md: var(--text-base--line-height);
  ...
  --ex-hover-card-description-line-height-sm: var(--text-xs--line-height);
  --ex-hover-card-description-line-height-md: var(--text-sm--line-height);
