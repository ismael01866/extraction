...
:root {
  ...
  --ex-drawer-section-gap-x-sm: calc(var(--spacing) * 2.5);
  --ex-drawer-section-gap-x-md: calc(var(--spacing) * 2.5);
  --ex-drawer-section-gap-x-lg: calc(var(--spacing) * 2.5);
  --ex-drawer-section-gap-x-xl: calc(var(--spacing) * 2.5);

  --ex-drawer-section-gap-y-sm: calc(var(--spacing) * 2.5);
  --ex-drawer-section-gap-y-md: calc(var(--spacing) * 2.5);
  --ex-drawer-section-gap-y-lg: calc(var(--spacing) * 2.5);
  --ex-drawer-section-gap-y-xl: calc(var(--spacing) * 2.5);
  ...
  --ex-drawer-title-line-height-sm: var(--text-base--line-height);
  --ex-drawer-title-line-height-md: var(--text-base--line-height);
  --ex-drawer-title-line-height-lg: var(--text-base--line-height);
  --ex-drawer-title-line-height-xl: var(--text-base--line-height);
  ...
  --ex-drawer-description-line-height-sm: var(--text-sm--line-height);
  --ex-drawer-description-line-height-md: var(--text-sm--line-height);
  --ex-drawer-description-line-height-lg: var(--text-sm--line-height);
  --ex-drawer-description-line-height-xl: var(--text-sm--line-height);
