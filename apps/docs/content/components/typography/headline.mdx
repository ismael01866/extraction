...
export const Component = <Headline>{`The quick brown fox jumps over the lazy dog`}</Headline>;
...
:root {
  ...
  --ex-headline-font-weight-sm: var(--font-weight-medium);
  --ex-headline-font-weight-md: var(--font-weight-medium);
  --ex-headline-font-weight-lg: var(--font-weight-medium);
  --ex-headline-font-weight-xl: var(--font-weight-medium);
}
```
