...
:root {
  ...
  --ex-menubar-trigger-gap-sm: calc(var(--spacing) * 1.25);
  --ex-menubar-trigger-gap-md: calc(var(--spacing) * 1.5);

  --ex-menubar-trigger-px-sm: calc(var(--spacing) * 2.5);
  --ex-menubar-trigger-px-md: calc(var(--spacing) * 3);
