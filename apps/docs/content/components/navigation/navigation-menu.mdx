...
:root {
  ...
  --ex-navigation-menu-height-md: calc(var(--spacing) * 12);
  ...
  --ex-navigation-menu-item-gap-x-sm: calc(var(--spacing) * 1.25);
  --ex-navigation-menu-item-gap-x-md: calc(var(--spacing) * 1.5);

  --ex-navigation-menu-item-px-sm: calc(var(--spacing) * 2.5);
  --ex-navigation-menu-item-px-md: calc(var(--spacing) * 3);
