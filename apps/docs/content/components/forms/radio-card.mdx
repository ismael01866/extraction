...
:root {
  ...
  --ex-radio-card-px-sm: calc(var(--spacing) * 3.5);
  --ex-radio-card-px-md: calc(var(--spacing) * 4);
  --ex-radio-card-px-lg: calc(var(--spacing) * 5);

  --ex-radio-card-py-sm: calc(var(--spacing) * 3.5);
  --ex-radio-card-py-md: calc(var(--spacing) * 4);
  --ex-radio-card-py-lg: calc(var(--spacing) * 5);
