...
export const ComponentDisabled = (
  <Field className='w-64'>
    ...
    <Input id='name' className='variant-surface disabled' placeholder='Enter your name' />
  </Field>
);
...
export const ComponentValid = (
  <Field className='w-64'>
    ...
    <Input id='name' className='valid' placeholder='Enter your name' readOnly value='John' />
