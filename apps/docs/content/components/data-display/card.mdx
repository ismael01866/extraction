...
export const Component = (
  <Card className='max-w-80'>
    <Card.Content>
      <Image
        alt='espresso'
        src='/images/assets/espresso.webp'
...
:root {
  ...
  --ex-card-section-gap-y-md: calc(var(--spacing) * 2.5);
  --ex-card-section-gap-y-lg: calc(var(--spacing) * 3);
  ...
  --ex-card-title-line-height-sm: var(--text-sm--line-height);
  --ex-card-title-line-height-md: var(--text-base--line-height);
  --ex-card-title-line-height-lg: var(--text-lg--line-height);
  ...
  --ex-card-description-line-height-sm: var(--text-xs--line-height);
  --ex-card-description-line-height-md: var(--text-sm--line-height);
  --ex-card-description-line-height-lg: var(--text-base--line-height);
