...
import { avatarCfg, avatarFallbackCfg, avatarGroupCfg, avatarImageCfg, cfg } from './avatar';
...
:root {
  ...
  --ex-avatar-size-lg: calc(var(--spacing) * 12);
  --ex-avatar-size-xl: calc(var(--spacing) * 14);
